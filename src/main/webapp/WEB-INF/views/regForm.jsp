        ...
        function kakaoPost(f) {
            new daum.Postcode({
                oncomplete: function (data) {
                    ...
                    f.address1.value = "(" + zonecode + ")" + address
                }
            }).open();
        }
    </script>
...
<hr/>
<br/>
<form name="f" method="post" action="/users" onsubmit="return doRegUserCheck(this);">
    ...
    <div class="divTable minimalistBlack">
        <div class="divTableBody">
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <input type="text" name="address1" style="width:85%"/>
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell">
                    <input type="text" name="address2" style="width:95%"/>
                </div>
            </div>
        </div>
    </div>
